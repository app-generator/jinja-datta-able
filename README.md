# [Datta Able](https://app-generator.dev/product/datta-able/flask/) Flask/Jinja

Open-source **Flask/Jinja Template** generated by `App-Generator` op top of **[Datta Able](https://app-generator.dev/product/datta-able/flask/)** a modern Bootstrap design. The project is a super `simple Flask project` WITHOUT database, ORM, or any other hard dependency. The project can be used as a codebase for future project or to migrate the Jinja files and assets to a legacy Python-based project that uses Jinja as template engine (Flask, Bottle, Django).
...
---
[Flask Datta Able](https://app-generator.dev/product/datta-able/flask/) - Open-Source **Flask**/Jinja Starter provided by [App Generator](https://app-generator.dev)